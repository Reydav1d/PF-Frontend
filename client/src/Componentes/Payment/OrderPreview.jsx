    ...
    <div className="bg-gray-50 min-h-screen">
      <div className="container_payment mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        <div className="block-heading text-center">
          <h2 className="text-2xl font-bold text-gray-900 sm:text-3xl">Detalles del pedido</h2>
        </div>
        ...
        {loading ? (
          <p className="text-gray-600">Cargando detalles de la orden...</p>
            ...
            <div className="products">
              <div className="item">
                <img src={orderData.Customer.image} alt="foto.cliente" className="h-24 w-24 rounded-full mx-auto" />
                        ...
                        <div>
                          ...
                          <dl className="mt-1 space-y-1 text-sm text-gray-600">
                            ...
                            <div>
                              ...
                              <dd className="inline text-sm">{selectedQuantities[product.id]}
                        ...
                        <div className="flex items-center justify-end gap-2">
                          <form className="flex items-center justify-end gap-2">
                            ...
                            <div className="flex justify-end justify-end gap-2 ">
                              ...
                              > </p>
                              <span className="flex justify-end ml-40" >{formatter.format(product.price)}</span>
                            </div>
                          </form>
                        </div>
                      </div>
                ...
                <div className="w-screen max-w-lg space-y-4">
                  <div className="space-y-1 text-sm text-gray-700">
                    <div  className="flex justify-between">
                      ...
                      <span className="mt-4 w-[200px] text-xl">{formatter.format(orderData.amount)}</span>
                    </div>
                  </div>
      ...
      >
        Volver al carrito
            ...
            <p className="text-gray-600">No se pudo obtener la información de la orden.</p>
          )}
